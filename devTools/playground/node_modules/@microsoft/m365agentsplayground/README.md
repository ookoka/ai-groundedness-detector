...
- **Automated Bot Testing**: Use [`@microsoft/m365agentsplayground-cli`](../playground-cli/README.md) to run multi-turn conversations against your bot programmatically — ideal for CI pipelines and LLM-based evaluation.
